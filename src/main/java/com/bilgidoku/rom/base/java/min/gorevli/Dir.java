package com.bilgidoku.rom.base.java.min.gorevli;
...
public class Dir {
	...
	private final static String TmpDir = Ortam.tek().isProd() ? BaseDataDir + "/gecici" : BaseDataDir + "/test/gecici";
	private final static String CheapDir = Ortam.tek().isProd() ? BaseDataDir + "/ucuz" : BaseDataDir + "/test/ucuz";
	private final static String BackupDir = Ortam.tek().isProd() ? BaseDataDir + "/sakla" : BaseDataDir + "/test/sakla";
	private final static String DataDir = Ortam.tek().isProd() ? BaseDataDir + "/onemli" : BaseDataDir + "/test/onemli";
	private final static String CodeDir = Ortam.tek().isProd() ? BaseDataDir + "/code" : BaseDataDir + "/test/code";
	private final static String RunDir = Ortam.tek().isProd() ? BaseDataDir + "/run" : BaseDataDir + "/test/run";
